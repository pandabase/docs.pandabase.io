...
<Steps>
  <Step title="Deploy a V2 verifier">
    Snippets in the [overview](/developers/webhooks/overview#verification). Easiest: a [Standard Webhooks SDK](https://www.standardwebhooks.com/#libraries).
  </Step>
  ...
  <Step title="Test">
    `POST /v2/stores/{storeId}/webhooks/{webhookId}/test`. Mirrors real deliveries.
  </Step>
