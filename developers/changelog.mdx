...
<Update label="May 25, 2026" description="Order metadata in exports" tags={["V2"]}>
## Features
...
<Update label="May 24, 2026" description="Clearer ledger notes" tags={["V2"]}>
## Improvements
...
<Update label="May 23, 2026" description="Store search endpoint" tags={["V2"]}>
## Features
...
<Update label="May 22, 2026" description="Reports API, Idempotency Keys & Email References" tags={["V2"]}>
## Features
...
<Update label="May 21, 2026" description="Usage-based billing" tags={["V2"]}>
## Features
...
- **New token scopes selectable in the dashboard**: `USAGE_READ`, `USAGE_WRITE`, `METERS_READ`, and `METERS_WRITE` can now be picked when minting an API token.
...
<Update label="May 17, 2026" description="Prevented disputes" tags={["V2"]}>
## Features
...
You can opt in by adding `PAYMENT_DISPUTE_PREVENTED` to your endpoint's `eventTypes`. See [events](/developers/webhooks/events) and the [disputes guide](/merchants/store/disputes).
