...
- **5 new merchant countries**: Pandabase is now available to merchants in Israel, Romania, Hong Kong, Philippines, and Morocco — bringing total coverage to **43 countries**. Local bank transfers are supported for Israel (IBAN), Romania (SEPA), and Morocco. Wire
  (SWIFT) payouts are available for Hong Kong and Philippines. Bank account field requirements and cross-border/FX fees are country-specific and match Stripe Global Payouts pricing (0.50%–1% cross-border, 1% FX).
