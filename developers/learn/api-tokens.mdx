...
API tokens authenticate requests to the [Store API](/developers/api/v2/introduction) at `/v2/core/stores/:storeId/*`. Each token has a set of permissions and uses one of two authentication modes: **Bearer** or **HMAC**.
