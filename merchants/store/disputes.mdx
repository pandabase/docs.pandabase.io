...
Sustained rates above 0.75% lead to outreach from us, additional review on new payments, and — if it doesn't come down — restrictions or loss of card acceptance. You can see your current rate on the [Analytics](/merchants/store/analytics) page.
