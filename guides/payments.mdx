...
<Steps>
  ...
  <Step title="Settlement">
    The net amount (sale minus fees) lands in your available balance, ready to [pay out](/payouts).
  </Step>
</Steps>
...
Refunds are issued from the action button in the top right. See [Refunds](/guides/refunds) for the full flow.
